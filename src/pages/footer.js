            ...
            <div className="container flex flex-col items-center sm:flex-row sm:justify-evenly">
                <div className="mb-4 sm:m-0 flex flex-col">
                    ...
                    <div className="sm:mt-4">
                        <p className="text-lg sm:text-xl">Oh my watch</p>
                ...
                <div className="my-10 sm:m-0">
                    <p className="text-lg sm:text-2xl">Contact us</p>
                    <p className="my-4"><PhoneAndroidIcon></PhoneAndroidIcon> 01fbcbfrbdfb</p>
                    <p ><LocationOnIcon></LocationOnIcon> North Korea</p>
                </div>
                <div className="flex flex-col">
                    <Link className="text-xs sm:text-base" to='/'>Home</Link>
                    <Link className="my-4 text-xs sm:text-base" to='/glasses'>Glasses</Link>
                    <Link className="text-xs sm:text-base" to='/watches'>Watches</Link>
                </div>
            </div>
        </div>
    );
